...
import { createBlogController, deleteBlogController, getBlogByIdController, getBlogController, updateBlogController } from "../controllers/blogController.js";
import { authenticate } from "../middlewares/auth.js";
import { blogValidation } from "../validations/blogValidation.js";

const router = express.Router();

router.post("/create", authenticate, upload, validator.body(blogValidation), createBlogController);
